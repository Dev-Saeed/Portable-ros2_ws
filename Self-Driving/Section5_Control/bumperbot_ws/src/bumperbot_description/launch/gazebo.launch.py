...
def generate_launch_description():
    ...
    # Get the path to the bumperbot_description package, which contains the URDF and other resources
    bumperbot_description = get_package_share_directory("bumperbot_description")
    
    # Get the installation prefix of the bumperbot_description package
